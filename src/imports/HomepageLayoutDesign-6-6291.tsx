...
import svgPaths from "./svg-6nbeme15k6";
...
import { imgImage11 } from "./svg-itwex";
              ...
              <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0">
                ...
                <div className="gap-x-[16px] gap-y-[16px] grid grid-cols-[repeat(6,minmax(0,1fr))] grid-rows-[repeat(1,minmax(0,1fr))] h-[134px] relative shrink-0 w-[1037px]" data-name="Section">
                  <div className="bg-white col-1 content-stretch flex flex-col gap-[16px] items-center justify-center justify-self-stretch p-px relative rounded-[16px] row-1 self-stretch shrink-0" data-name="Link">
                    ...
                    <BackgroundImage4 additionalClassNames="w-[51.281px]">
                      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[26.5px] not-italic text-[#314158] text-[14px] text-center top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Aircraft</p>
                    </BackgroundImage4>
                  </div>
                  <div className="bg-white col-3 content-stretch flex flex-col gap-[16px] items-center justify-center justify-self-stretch p-px relative rounded-[16px] row-1 self-stretch shrink-0" data-name="Link">
                    ...
                    <BackgroundImage4 additionalClassNames="w-[105.086px]">
                      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[53px] not-italic text-[#314158] text-[14px] text-center top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">{`Cars & Vehicles`}</p>
                    </BackgroundImage4>
                  </div>
                  <div className="bg-white col-2 content-stretch flex flex-col gap-[16px] items-center justify-center justify-self-stretch p-px relative rounded-[16px] row-1 self-stretch shrink-0" data-name="Link">
                    ...
                    <BackgroundImage4 additionalClassNames="w-[84.391px]">
                      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[42px] not-italic text-[#314158] text-[14px] text-center top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Architecture</p>
                    </BackgroundImage4>
                  </div>
                  <div className="bg-white col-5 content-stretch flex flex-col gap-[16px] items-center justify-center justify-self-stretch p-px relative rounded-[16px] row-1 self-stretch shrink-0" data-name="Link">
                    ...
                    <BackgroundImage4 additionalClassNames="w-[37.625px]">
                      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[19px] not-italic text-[#314158] text-[14px] text-center top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Ships</p>
                    </BackgroundImage4>
                  </div>
                  <div className="bg-white col-4 content-stretch flex flex-col gap-[16px] items-center justify-center justify-self-stretch p-px relative rounded-[16px] row-1 self-stretch shrink-0" data-name="Link">
                    ...
                    <BackgroundImage4 additionalClassNames="w-[50.625px]">
                      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[25px] not-italic text-[#314158] text-[14px] text-center top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Military</p>
                    </BackgroundImage4>
                  </div>
                  <div className="bg-white col-6 content-stretch flex flex-col gap-[16px] items-center justify-center justify-self-stretch p-px relative rounded-[16px] row-1 self-stretch shrink-0" data-name="Link">
                    ...
                    <BackgroundImage4 additionalClassNames="w-[60.578px]">
                      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[30px] not-italic text-[#314158] text-[14px] text-center top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Beginner</p>
                    </BackgroundImage4>
                  </div>
                </div>
              </div>
              <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full">
                ...
                <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(3,minmax(0,1fr))] grid-rows-[repeat(2,minmax(0,1fr))] h-[836px] relative shrink-0 w-[1035px]" data-name="Container">
                  <ContainerBackgroundImage1 additionalClassNames="col-1 row-1">
                    ...
                    <div className="h-[168px] relative shrink-0 w-full" data-name="Container">
                      <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[16px] top-[16px] w-[295px]">
                        <BackgroundImageAndText text="Czech Castle" />
                        <BackgroundImage2 />
                      </div>
                    </div>
                  ...
                  <ContainerBackgroundImage1 additionalClassNames="col-2 row-1">
                    ...
                    <div className="h-[168px] relative shrink-0 w-full" data-name="Container">
                      <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[16px] top-[16px] w-[295px]">
                        <BackgroundImageAndText text="Classic Ship" />
                        <BackgroundImage2 />
                      </div>
                    </div>
                  </ContainerBackgroundImage1>
                  <ContainerBackgroundImage1 additionalClassNames="col-3 row-1">
                    ...
                    <div className="h-[168px] relative shrink-0 w-full" data-name="Container">
                      <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[16px] top-[16px] w-[295px]">
                        <BackgroundImageAndText text="Old Castle" />
                        <BackgroundImage2 />
                      </div>
                    </div>
                  </ContainerBackgroundImage1>
                  <ContainerBackgroundImage1 additionalClassNames="col-1 row-2">
                    ...
                    <div className="h-[168px] relative shrink-0 w-full" data-name="Container">
                      <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[16px] top-[16px] w-[295px]">
                        <BackgroundImageAndText text="Emergency car" />
                        <BackgroundImage2 />
                      </div>
                    </div>
                  </ContainerBackgroundImage1>
                  <ContainerBackgroundImage1 additionalClassNames="col-2 row-2">
                    ...
                    <div className="h-[168px] relative shrink-0 w-full" data-name="Container">
                      <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[16px] top-[16px] w-[295px]">
                        <BackgroundImageAndText text="Football Stadium" />
                        <BackgroundImage2 />
                      </div>
                    </div>
                  </ContainerBackgroundImage1>
                  <ContainerBackgroundImage1 additionalClassNames="col-3 row-2">
                    ...
                    <div className="h-[168px] relative shrink-0 w-full" data-name="Container">
                      <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[16px] top-[16px] w-[295px]">
                        <BackgroundImageAndText text="Classic car" />
                        <BackgroundImage2 />
                      </div>
                    </div>
                  </ContainerBackgroundImage1>
