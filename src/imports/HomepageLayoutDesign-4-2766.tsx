...
import svgPaths from "./svg-dmbl2f1ijx";
...
import { imgImage11 } from "./svg-qyegl";
...
function BackgroundImage7({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="relative shrink-0 w-full">
      <div className="content-stretch flex flex-col items-start px-[32px] relative w-full">{children}</div>
    </div>
  );
}
...
function BackgroundImage4({ children, additionalClassNames = "" }: React.PropsWithChildren<{ additionalClassNames?: string }>) {
  return (
    <div className={clsx("h-[20px] relative shrink-0 flex items-center justify-center", additionalClassNames)}>
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative flex items-center justify-center w-full">{children}</div>
    </div>
  );
}
...
function BackgroundImageAndText1({ text, additionalClassNames = "" }: BackgroundImageAndText1Props) {
  return (
    <Link to="/models/1" className={clsx("flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] hover:opacity-90 transition-opacity", additionalClassNames)}>
  ...
  return (
    <div className="bg-white relative size-full" data-name="Homepage layout design">
      <div className="absolute bg-white content-stretch flex flex-col items-start left-0 top-0 w-[1101px]" data-name="Body">
        <div className="bg-[#f8fafc] content-stretch flex flex-col items-start pt-[20px] relative shrink-0 w-full" data-name="div">
          <div className="relative shrink-0" data-name="Main Content">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[64px] items-center pt-[40px] relative">
                ...
                <div className="gap-x-[16px] gap-y-[16px] grid grid-cols-[repeat(6,minmax(0,1fr))] grid-rows-[repeat(1,minmax(0,1fr))] h-[134px] relative shrink-0 w-[1037px]" data-name="Section">
                  <div className="bg-white col-1 content-stretch flex flex-col gap-[16px] items-center justify-center justify-self-stretch p-px relative rounded-[16px] row-1 self-stretch shrink-0" data-name="Link">
                    ...
                    <BackgroundImage4 additionalClassNames="w-full">
                      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic text-[#314158] text-[14px] text-center tracking-[-0.1504px] whitespace-nowrap">Aircraft</p>
                    </BackgroundImage4>
                  </div>
                  <div className="bg-white col-3 content-stretch flex flex-col gap-[16px] items-center justify-center justify-self-stretch p-px relative rounded-[16px] row-1 self-stretch shrink-0" data-name="Link">
                    ...
                    <BackgroundImage4 additionalClassNames="w-full">
                      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic text-[#314158] text-[14px] text-center tracking-[-0.1504px] whitespace-nowrap">{`Cars & Vehicles`}</p>
                    </BackgroundImage4>
                  </div>
                  <div className="bg-white col-2 content-stretch flex flex-col gap-[16px] items-center justify-center justify-self-stretch p-px relative rounded-[16px] row-1 self-stretch shrink-0" data-name="Link">
                    ...
                    <BackgroundImage4 additionalClassNames="w-full">
                      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic text-[#314158] text-[14px] text-center tracking-[-0.1504px] whitespace-nowrap">Architecture</p>
                    </BackgroundImage4>
                  </div>
                  <div className="bg-white col-5 content-stretch flex flex-col gap-[16px] items-center justify-center justify-self-stretch p-px relative rounded-[16px] row-1 self-stretch shrink-0" data-name="Link">
                    ...
                    <BackgroundImage4 additionalClassNames="w-full">
                      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic text-[#314158] text-[14px] text-center tracking-[-0.1504px] whitespace-nowrap">Ships</p>
                    </BackgroundImage4>
                  </div>
                  <div className="bg-white col-4 content-stretch flex flex-col gap-[16px] items-center justify-center justify-self-stretch p-px relative rounded-[16px] row-1 self-stretch shrink-0" data-name="Link">
                    ...
                    <BackgroundImage4 additionalClassNames="w-full">
                      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic text-[#314158] text-[14px] text-center tracking-[-0.1504px] whitespace-nowrap">Military</p>
                    </BackgroundImage4>
                  </div>
                  <div className="bg-white col-6 content-stretch flex flex-col gap-[16px] items-center justify-center justify-self-stretch p-px relative rounded-[16px] row-1 self-stretch shrink-0" data-name="Link">
                    ...
                    <BackgroundImage4 additionalClassNames="w-full">
                      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic text-[#314158] text-[14px] text-center tracking-[-0.1504px] whitespace-nowrap">Beginner</p>
                    </BackgroundImage4>
                  </div>
                </div>
              </div>
              <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full">
                <div className="content-stretch flex flex-col gap-[12px] h-[80px] items-start px-[8px] relative shrink-0 w-[1035px]" data-name="Container">
                  <div className="h-[40px] relative shrink-0 w-full" data-name="h2">
                    ...
                    <Link to="/models" className="absolute bg-white border-2 border-[#4a90e2] border-solid h-[36px] left-[893px] rounded-[12px] top-[44px] w-[134px] hover:bg-[#eff6ff] transition-colors" data-name="Button">
              ...
              <BackgroundImage7>
                <div className="h-[421px] overflow-clip relative rounded-[32px] shrink-0 w-full" data-name="div" style={{ backgroundImage: "linear-gradient(69.8727deg, rgb(0, 0, 17) 0%, rgb(136, 139, 162) 100%)" }}>
                  <div className="absolute content-stretch flex flex-col gap-[33px] items-start left-[40px] top-[40px] w-[506px]">
                    <div className="content-stretch flex flex-col gap-[16px] items-start not-italic relative shrink-0 w-full">
                      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[48px] text-white w-[497px]">The legendary ABC magazine</p>
                      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[32.5px] min-w-full relative shrink-0 text-[20px] text-[rgba(255,255,255,0.9)] tracking-[-0.4492px] w-[min-content]">A legendary magazine for boys and girls, which has been bringing the best of science, technology, nature and, above all, unique paper cutouts and models to its pages since 1957.</p>
                    </div>
                    <div className="bg-white content-stretch flex items-center justify-center px-[16px] py-[12px] relative rounded-[12px] shrink-0">
                      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#101828] text-[18px] text-center w-[124px]">Explore ABC</p>
                    </div>
                  </div>
                  <div className="absolute contents left-[677px] top-[40px]" />
                  <div className="absolute h-[197px] left-[587px] top-[95px] w-[410px]" data-name="932b0f90-1 1">
                    <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img932B0F9011} />
                  </div>
                </div>
              </BackgroundImage7>
            </div>
      ...
      {/* Header is now rendered in HomePage component */}
      <div className="absolute bg-white content-stretch flex flex-col h-[81px] items-start left-0 px-[40px] top-0 w-[1101px] hidden" data-name="header">
        ...
        <div className="content-stretch flex h-[80px] items-center relative shrink-0 w-full" data-name="div">
          ...
          <div className="h-[38px] relative shrink-0" data-name="Container">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] h-full items-center relative">
              <ButtonBackgroundImage additionalClassNames="rounded-[16777200px]">
